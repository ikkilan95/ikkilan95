...
- Architected a Medallion Data Platform: Designed and implemented a structured Medallion Architecture (Bronze, Silver, and Gold layers) to systematically clean, enrich, and transform raw relational data into production-ready assets.
- Streamlined Data Ingestion: Developed robust ETL/ELT pipelines using Microsoft SQL Server to ingest large-scale CSV flat files, ensuring schema validation and initial data integrity at the ingestion gate.
- Implemented Strict 3NF Normalization: Normalized transactional staging areas up to Third Normalist Form (3NF) to eliminate data redundancy, enforce strict data integrity, and minimize anomalies during the transformation phase.
